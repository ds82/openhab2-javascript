 ...
 * https://github.com/lewie/openhab2-javascript/blob/master/jslib/triggersAndConditions.js
 */

'use strict';
var OPENHAB_CONF = Java.type('java.lang.System').getenv('OPENHAB_CONF');
load(OPENHAB_CONF + '/automation/jsr223/lib/base.js');
...
if (Visibility == undefined)
  var Visibility = Java.type('org.eclipse.smarthome.automation.Visibility');
if (TriggerHandler == undefined)
  var TriggerHandler = Java.type(
    'org.eclipse.smarthome.automation.handler.TriggerHandler'
  );
if (Trigger == undefined)
  var Trigger = Java.type('org.eclipse.smarthome.automation.Trigger');
if (ModuleBuilder == undefined)
  var ModuleBuilder = Java.type(
    'org.eclipse.smarthome.automation.core.util.ModuleBuilder'
  );

//Handlers
if (ChannelEventTriggerHandler == undefined)
  var ChannelEventTriggerHandler = Java.type(
    'org.eclipse.smarthome.automation.module.core.handler.ChannelEventTriggerHandler'
  );
if (CompareConditionHandler == undefined)
  var CompareConditionHandler = Java.type(
    'org.eclipse.smarthome.automation.module.core.handler.CompareConditionHandler'
  );
...
if (ItemCommandTriggerHandler == undefined)
  var ItemCommandTriggerHandler = Java.type(
    'org.eclipse.smarthome.automation.module.core.handler.ItemCommandTriggerHandler'
  );
if (ItemStateConditionHandler == undefined)
  var ItemStateConditionHandler = Java.type(
    'org.eclipse.smarthome.automation.module.core.handler.ItemStateConditionHandler'
  );
if (ItemStateTriggerHandler == undefined)
  var ItemStateTriggerHandler = Java.type(
    'org.eclipse.smarthome.automation.module.core.handler.ItemStateTriggerHandler'
  );
...
if (GenericCronTriggerHandler == undefined)
  var GenericCronTriggerHandler = Java.type(
    'org.eclipse.smarthome.automation.module.timer.handler.GenericCronTriggerHandler'
  );
...
// ### ChangedEventTrigger ###
var ItemStateChangeTrigger = function(
  itemName,
  oldState,
  newState,
  triggerName
...
var ItemCommandTrigger = function(itemName, command, triggerName) {
  ...
  return ModuleBuilder.createTrigger()
    .withId(getTrName(triggerName))
    .withTypeUID(ItemCommandTriggerHandler.MODULE_TYPE_ID)
    .withConfiguration(
      new Configuration({
        itemName: itemName,
        command: command
...
var ItemStateCondition = function(itemName, state, condName) {
  return ModuleBuilder.createCondition()
    .withId(getTrName(condName))
...
var GenericCompareCondition = function(itemName, state, operator, condName) {
  return ModuleBuilder.createCondition()
    .withId(getTrName(condName))
    .withTypeUID(CompareConditionHandler.MODULE_TYPE)
    .withConfiguration(
      new Configuration({
        itemName: itemName,
...
var getTrName = function(trn) {
  return trn == undefined || trn == null || trn == ''
    ? uuid.randomUUID() + '-' + me.replace(/[^\w]/g, '-')
    : trn;
