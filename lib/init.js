...
require('external/moment.js');
require('external/ramda.js');

require('lib/rhino.js');
...
(function(context) {
  ...
  /**
   * trigger for channel events
   * @param {string} channel - The channel this trigger observes
   * @param {string} event - The event this trigger should look for
   * @param {string} [triggerName] - (optional) Name of trigger
   *
   * @example
   * channelTrigger('astro:sun:home_offsetm10:set#event', 'START')
   */
